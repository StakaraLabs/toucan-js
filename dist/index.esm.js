...
class ToucanClient extends ServerRuntimeClient {
    ...
    eventFromException(exception, hint) {
        return resolvedSyncPromise(eventFromUnknownInput(this.hashsdk, this._options.stackParser, exception, hint));
    }
...
class Toucan extends Scope {
    ...
    attachNewClient() {
        const client = new ToucanClient({
            ...
            stackParser: stackParserFromStackParserOptions(this.hashoptions.stackParser || defaultStackParser),
            transportOptions: {
